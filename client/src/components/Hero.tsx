...
export default function Hero() {
  ...
  useEffect(() => {
    // Simple typing effect or reveal animation could go here
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container relative z-30 flex flex-col items-center text-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 animate-fade-in-up animation-delay-400">
          Transformo ideias complexas em experiências digitais fluidas e performáticas. 
          Especialista em criar soluções web modernas com foco em design e usabilidade.
        </p>
